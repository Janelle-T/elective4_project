...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid px-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#criteriaModal">
                                Add Criteria
                            </button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="criteriaForm" method="post" action="<?= base_url('evaluation/saveCriteria') ?>">
                            ...
                            <!-- DataTable -->
                            <table id="criteriaTable" class="table table-bordered mt-4">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Title</th>
    ...
    <script>
       $(document).ready(function() {
            // Initialize DataTable for criteriaTable

...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid px-4">
                    <div class="card mb-4">
                        <div class="card-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="ratingForm" method="post" action="<?= base_url('evaluation/saveRating') ?>">
                                                <label>Rate (1-5):</label>
                                                <input type="number" name="rate" min="1" max="5" required class="form-control"><br>

                                                <label>Descriptive Rating:</label>
                                                <input type="text" name="descriptive_rating" required class="form-control"><br>

                                                <label>Qualitative Description:</label>
                                                <textarea name="qualitative_description" required class="form-control"></textarea><br>
                            ...
                            <!-- DataTable -->
                            <table id="ratingTable" class="table table-bordered mt-4">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($ratingRecords as $rating): ?>
                                        <tr>
                                            
                                            <td><?= esc($rating['rate']) ?></td>
                                            <td><?= esc($rating['descriptive_rating']) ?></td>
                                            <td><?= esc($rating['qualitative_description']) ?></td>
                                            <td>
    ...
    <script>
       $(document).ready(function() {
            // Initialize DataTable for ratingTable

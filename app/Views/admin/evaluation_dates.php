                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url('evaluation-dates/edit') ?>" method="post" id="editForm">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="edit-open-datetime" class="form-label">Open Date & Time</label>
                                                        <input type="datetime-local" name="open_datetime" class="form-control" id="edit-open-datetime" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="edit-close-datetime" class="form-label">Close Date & Time</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            editModal.addEventListener('show.bs.modal', event => {
                ...
                document.getElementById('edit-open-datetime').value = button.getAttribute('data-open-datetime');
                document.getElementById('edit-close-datetime').value = button.getAttribute('data-close-datetime');
            });
        });

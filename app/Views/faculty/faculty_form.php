...
<body>
     <div class="container mt-3">
        ...
        <div class="content">
            <form id="facultyForm" method="post" action="<?= base_url('faculty/register') ?>" enctype="multipart/form-data">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <div class="input-group">
                            <input type="text" id="faculty_id" name="faculty_id" placeholder="Enter your faculty ID" required>
    ...
    <script>
        document.getElementById('college').addEventListener('change', function() {
            ...
            fetch('<?= base_url('faculty/getDepartments/') ?>' + collegeId)
